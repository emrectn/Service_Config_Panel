...
public class PersistenceJPAConfig {
	...
	@Value("${datasource.sampleapp.maxPoolSize:10}0")
	...
	private Properties jpaProperties() {
		...
		properties.put("hibernate.temp.use_jdbc_metadata_defaults", environment.getRequiredProperty("datasource.sampleapp.hibernate.temp.use_jdbc_metadata_defaults"));
